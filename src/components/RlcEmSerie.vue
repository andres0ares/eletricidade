...
export default {
    ...
    methods: {
        calcularS () {
            ...
            let s1 = `-\\left(\\frac{${R.v}}{2\\cdot \\:\\left(${L.v}\\right)}\\right)\\:+\\sqrt{\\left(\\frac{${R.v}}{2\\cdot \\:\\left(${L.v}\\right)}\\right)^2-\\left(\\frac{1}{\\sqrt{\\left(${L.v}\\right)\\left(${C.v}\\right)}}\\right)^2}`;
            let s2 = `-\\left(\\frac{${R.v}}{2\\cdot \\:\\left(${L.v}\\right)}\\right)\\:-\\sqrt{\\left(\\frac{${R.v}}{2\\cdot \\:\\left(${L.v}\\right)}\\right)^2-\\left(\\frac{1}{\\sqrt{\\left(${L.v}\\right)\\left(${C.v}\\right)}}\\right)^2}`;
